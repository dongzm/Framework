...
namespace Framework.Core.Query
{
    ...
    public abstract class BaseQueryOra<T, V> where T: BaseQueryCondition where V: BaseQueryResult
    {
        ...
        public List<V> Query(T condition)
        {
            ...
            DataSet ds = DbQueryHelperOra.Query(sql, this.GetCondition(sql, condition));
        ...
        {
            string sql = this.GetSql(condition);
            DataSet ds = DbQueryHelperOra.Query(sql, this.GetCondition(sql, condition), orderby);
            return this.ConvertToCollection(ds);
        }
        ...
        {
            string sql = this.GetSql(condition);
            DataSet ds = DbQueryHelperOra.Query(sql, this.GetCondition(sql, condition), pagingInfo, orderby);
            return this.ConvertToCollection(ds);
        }
    }
}
